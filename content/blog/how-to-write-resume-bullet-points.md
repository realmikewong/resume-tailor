...
faq:
  ...
  - q: "Should every bullet start with an action verb?"
    a: "Yes, but you don't need a different one every time. Overusing unique verbs (spearheaded, orchestrated) sounds fake. Stick to common ones like 'led', 'built', 'designed', 'improved', and 'managed'."
  - q: "How long should a bullet point be?"
    a: "One to two lines. If it goes longer, you probably packed too much into one bullet. Break it into two. Your bullets should be skimmable."
---
...
Before: Just a job duty.
After: You made a specific thing better in a measurable way.
