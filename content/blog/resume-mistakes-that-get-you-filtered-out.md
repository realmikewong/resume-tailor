...
faq:
  ...
  - q: "Can a good resume still get filtered out by ATS?"
    a: "Yes. If the formatting is wrong or the language doesn't match the job description, even a strong resume can be filtered out before a recruiter sees it."
...
**Fix:** [Tailor your resume](/blog/how-to-tailor-your-resume-to-a-job-description) to each job. Mirror the posting's keywords in your summary, bullets, and skills section.
...
**Fix:** Write a [specific summary](/blog/how-to-write-a-resume-summary) that names your title, your most relevant experience, and one concrete result. Tailor it to each application.
